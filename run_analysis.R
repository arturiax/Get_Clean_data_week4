...
#The names of the features are not in a valid R form, we change that
...
# means or standard deviations of the signals
...
#If you clone the repo you can read the table with:
